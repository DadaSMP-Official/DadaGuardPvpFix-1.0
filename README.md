...
> Fa prevalere le sottozone PvP allow dentro regioni spawn protette.
...
**DadaGuardPvpFix 1.0** is a custom Minecraft plugin for Paper/Spigot servers.

Fa prevalere le sottozone PvP allow dentro regioni spawn protette.

| Field | Value |
| --- | --- |
| Plugin | `DadaGuardPvpFix` |
| Version | `1.0` |
| Category | Security and Staff Tools |
| Main class | `it.dadasmp.guardpvpfix.DadaGuardPvpFix` |
| Dependencies | `depend: [DadaGuard]` |
...
`release/DadaGuardPvpFix-1.0.jar`
